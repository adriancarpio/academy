...
<div class="wrapper">
  ...
  <header class="main-header">
   ...
   <a href="./" class="logo">
      ...
      <span class="logo-lg"><b>Holy</b>Schools</span>
    </a>
...
<?php if($user->kind):?>
         <li><a href="./?view=a_academico&opt=all"><i class="fa  fa-hourglass-end"></i> <span>Ciclo Escolar</span></a></li>
         <li><a href="./?view=estudiantes&opt=all"><i class="fa fa-users"></i> <span>Estudiantes</span></a></li>
         <li><a href="./?view=allgrados"><i class="fa fa-list-ol"></i> Grados</a></li>
...
?>
 ...
 <!-- <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2018-2019 <a href="http://almsaeedstudio.com">AngshelinoWeb</a>.</strong> Todos los derechos
    reservados.
  </footer>-->
...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>Holy</b>Schools</a>
  </div>
  <!-- /.login-logo -->
